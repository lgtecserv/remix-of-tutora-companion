...
export const Route = createFileRoute("/tutor-panel/cursos/$id")({ component: EditCourse });
...
function EditCourse() {
  ...
  return (
    <div className="space-y-6">
      <Link to="/tutor-panel/cursos" className="text-sm text-muted-foreground hover:text-primary">← Voltar para cursos</Link>
